...
CSV_CONFIG = {
    ...
    "ux-laws": {
        "file": "ux-laws.csv",
        "search_cols": ["Law_Name", "Law_Category", "Product_Type", "Application", "Anti_Pattern"],
        "output_cols": ["ID", "Law_Name", "Law_Category", "Definition", "Product_Type",
                        "Application", "Design_Test_ID", "Pass_Criteria", "Anti_Pattern",
                        "Severity", "Metric", "Expected_Impact"]
    },
    "design-tests": {
        "file": "design-tests.csv",
        "search_cols": ["Target", "Component", "UX_Law_Name", "Assertion", "Pass_Criteria"],
