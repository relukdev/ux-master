...
<!-- Generated by UX Master — https://ux-master.todyai.io -->
<html lang="en" data-theme="light">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="generator" content="UX Master — https://ux-master.todyai.io">
...
{nav_html}    </nav>
    <div class="sidebar-footer">
      ...
      <a href="https://ux-master.todyai.io" target="_blank" rel="noopener" style="display:block;margin-top:8px;font-size:10px;color:inherit;opacity:0.4;text-decoration:none">ux-master.todyai.io</a>
    </div>
  </aside>
