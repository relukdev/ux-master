...
# -*- coding: utf-8 -*-
"""
UX Master — Multi-Platform Installer
...
SKILL_DESCRIPTION = (
    "Ultimate UI/UX design intelligence with 48 UX Laws, 37 Design Tests (TDD for Design), "
    "Design System Extractor, BM25 search across 13 domains and 13 stacks. "
    "Use when designing, building, reviewing, or improving any UI/UX."
)
SKILL_DESCRIPTION_LONG = (
    "UI/UX design intelligence. 67 styles, 96 palettes, 57 font pairings, 48 UX Laws, "
...
def generate_cursorrules(project_dir: Path) -> str:
    ...
    return f"""# UX Master Design Intelligence
...
class Installer:
    ...
    def install(self):
        ...
        print(f"\n{'='*60}")
        print(f"  UX Master Installer — {self.config['name']}")
        print(f"{'='*60}")
        ...
        if self.platform == "cursor":
            ...
            if rules_file.exists():
                ...
                if SKILL_NAME not in existing:
                    ...
                    print(f"  📝 Appended UX Master rules to .cursorrules")
                else:
                    print(f"  ⏭️  .cursorrules already contains UX Master reference")
            else:
                self._write_file(rules_file, snippet)
                print(f"  📝 Created .cursorrules with UX Master rules")
            ...
            if gemini_md.exists():
                ...
                if SKILL_NAME not in existing:
                    ...
                    print(f"  📝 Appended UX Master instructions to GEMINI.md")
                else:
                    print(f"  ⏭️  GEMINI.md already contains UX Master reference")
            else:
                self._write_file(gemini_md, f"# Gemini CLI Configuration\n{snippet}")
                print(f"  📝 Created GEMINI.md with UX Master instructions")
            ...
            if agents_md.exists():
                ...
                if SKILL_NAME not in existing:
                    ...
                    print(f"  📝 Appended UX Master instructions to AGENTS.md")
                else:
                    print(f"  ⏭️  AGENTS.md already contains UX Master reference")
            else:
                self._write_file(agents_md, f"# Agent Instructions\n{snippet}")
                print(f"  📝 Created AGENTS.md with UX Master instructions")
...
def list_platforms():
    ...
    print(f"\n{'='*60}")
    print(f"  UX Master — Supported Platforms")
    print(f"{'='*60}\n")
...
def interactive_select():
    ...
    print(f"\n{'='*60}")
    print(f"  UX Master — Interactive Installer")
    print(f"{'='*60}\n")
...
def main():
    parser = argparse.ArgumentParser(
        description="UX Master — Multi-Platform Installer",
